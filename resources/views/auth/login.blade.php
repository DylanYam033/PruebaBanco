...
<div class="card card-primary">
    ...
    <div class="col-md-15 col-lg-20 d-none d-md-block" style="border-radius: 1rem; text-align: center;">
        <img src="https://i.ibb.co/tHYhPhH/klipartz-com.png" alt="login form" class="img-fluid" width="50%" style="margin-left: auto; margin-right: auto;" />
    </div>
